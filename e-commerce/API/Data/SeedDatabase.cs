...
public static class SeedDatabase
{
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Ertug Bey", UserName = "ertugbey", Email = "ertugbey@gmail.com" };
            var admin = new AppUser { Name = "Mercan Hanim", UserName = "mercanhanim", Email = "mercanhanim@gmail.com" };
